...
class Cities extends Base
{
	...
	protected function show_cms_list()
	{
		...
		$list->data = \Services\Factory::get_instance('city')->get_cms_list($request,$page,$limit);
		$list->total = \Services\Factory::get_instance('city')->get_total_count($request);
	...
	protected function show_add_form()
	{
		...
		$value = new \stdClass();
		$value = $this->get_values($site, ['city_id' => 0]);
	...
	protected function add()
	{
		...
		\Services\Factory::get_instance('city')->insert($request);
	...
	protected function update()
	{
		...
		\Services\Factory::get_instance('city')->update($request);
