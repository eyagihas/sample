...
class TShinbiRecommendClinics extends Base
{
    use \Modelings\ShinbiRecommendClinics;

    public function __construct()
    {
        parent::__construct();
        $this->_tableName = 't_shinbi_recommend_clinics';
    }
    ...
    public function get_list($recommend_id, $isPreview = false, $isCms = false)
    {
        ...
        try {
            $sub_query = $this->_db->table('t_shinbi_recommend_clinic_features'.$postfix)
                ->select(
                    'recommend_id',
                    'clinic_id',
                ...
                ->where('recommend_id','=',$recommend_id)
                ->groupBy('clinic_id');
            $fee_sub_query = $this->_db->table('t_shinbi_recommend_clinic_fees'.$postfix)
                ->select(
                    'recommend_id',
                    'clinic_id',
                ...
                ->where('recommend_id','=',$recommend_id)
                ->groupBy('clinic_id');
            $flow_sub_query = $this->_db->table('t_shinbi_recommend_clinic_flows'.$postfix)
                ->select(
                    'recommend_id',
                    'clinic_id',
            ...
            return $this->_db->table($this->_tableName.$postfix.' as rc')
                ...
                ->join('t_shinbi_clinics as sc', 'rc.clinic_id', '=', 'sc.clinic_id')
    ...
    public function get_list_by_clinic($clinic_id, $page = null, $limit = null, $recommend_id = 0, $is_pr = false)
    {
        try {
            $list = $this->_db->table($this->_tableName.' as rc')
                ...
                ->join('t_shinbi_recommends as r', 'rc.recommend_id', '=', 'r.recommend_id')
