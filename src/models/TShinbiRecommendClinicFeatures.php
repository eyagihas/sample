...
class TShinbiRecommendClinicFeatures extends Base
{
    ...
    {
        parent::__construct();
        $this->_tableName = 't_shinbi_recommend_clinic_features';
    }
    ...
    public function get_by_clinic_id($recommend_id, $clinic_id, $isPreview = false)
    {
        ...
        try {
            ...
            ->leftJoin('t_shinbi_cases'.$postfix.' as c','f.case_id','=','c.case_id')
